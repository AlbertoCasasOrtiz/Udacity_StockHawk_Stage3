...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    public void onBindViewHolder(StockViewHolder holder, int position) {
        ...
        holder.history = cursor.getString(Contract.Quote.POSITION_HISTORY);
        holder.stockName = cursor.getString(Contract.Quote.POSITION_STOCK_NAME);
        holder.changeAbsolute = cursor.getString(Contract.Quote.POSITION_ABSOLUTE_CHANGE);
